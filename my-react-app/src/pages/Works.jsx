...
const Work = () => {
  ...
  useEffect(() => {
    ...
    fetch('https://portfolio-tfli.onrender.com/api/projects')
      .then(res => res.json())
      .then(data => {
        setProjects(data);
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('https://portfolio-tfli.onrender.com/api/projects', {
        method: 'POST',
        credentials: 'include',
        body: formData,
      });
  ...
  const handleDeleteProject = async (id) => {
    ...
    try {
      const res = await fetch(`https://portfolio-tfli.onrender.com/api/projects/${id}`, {
        method: 'DELETE',
        credentials: 'include',
      });
      if (!res.ok) {
  ...
  const submitEditProject = async (e) => {
    ...
    try {
      const response = await fetch(`https://portfolio-tfli.onrender.com/api/projects/${editProjectId}`, {
        method: 'PUT',
        credentials: 'include',
                    ...
                    <img
                      ...
                      src={
                        project.image_url.startsWith('/uploads')
                          ? `https://portfolio-tfli.onrender.com${project.image_url}`
                          : project.image_url
                      }
                      alt={project.title}
                      onClick={() =>
                  ...
                  {project.screenshots && (
                    <div className="project-screenshots">
                      {JSON.parse(project.screenshots).map((fileUrl, index) => {
                        ...
                        const item = {
                          url: `https://portfolio-tfli.onrender.com${fileUrl}`,
                          isPdf
                        };
                        return (
                            ...
                            {isPdf ? (
                              <iframe
                                ...
                                onClick={() => openModal(JSON.parse(project.screenshots).map(url => ({
                                  url: `https://portfolio-tfli.onrender.com${url}`,
